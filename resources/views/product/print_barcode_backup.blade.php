        ...
        if(paper_size != "0") {
            ...
            $.each(qty, function(index){
                ...
                while(i < qty[index]) {
                    ...
                    if(paper_size == 18)
                        htmltext += '<img style="max-width:150px;height:100%;max-height:12px" src="data:image/svg+xml;base64,'+barcode_image[index]+'" alt="barcode" /><br>';
                    else
                        htmltext += '<img style="max-width:150px;height:100%;max-height:20px" src="data:image/svg+xml;base64,'+barcode_image[index]+'" alt="barcode" /><br>';
