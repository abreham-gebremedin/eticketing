                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="employee_name" required class="form-control" placeholder="eg. Abreham Gebremedin Debele">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="number" value="0" required step="any"    name="basic_salary"  class="form-control"/>
                                </div>
                                <div class="form-group">
                                    <label>Transpotation Allowance </label>
                                    <input  type="number" value="0" required step="any"    name="transport_allowance" required class="form-control"/>
                                </div>
                                <div class="form-group">
                                    <label>House Allowance</label>
                                    <input  type="number" value="0" required step="any"    name="house_allowance" required class="form-control"/>
                                </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <input  type="number" value="0" required step="any"    name="fuel_allowance" required class="form-control"/>
                                </div>
                                
                                <div class="form-group">
                                    <label>Position Allowance</label>
                                    <input  type="number" value="0" required step="any"    name="position" required class="form-control"/>
                                </div>
                                <div class="form-group">
                                    <label>Deduction</label>
                                    <input  type="number" value="0" required step="any"    name="deduction" required class="form-control"/>
                                </div>
