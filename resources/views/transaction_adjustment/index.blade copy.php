...
<section>
    <div class="container-fluid">
        <div class="card">
            ...
            {!! Form::open(['route' => 'transaction_adjustments.index', 'method' => 'get']) !!}
            <div class="row mb-3">
              ...
              <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                ...
                ?>
                  <div class="form-group">
                      ...
                      <p id="reference">{{'account-adjustment-' . date("Ymd") . '-'. date("his")}}</p>
                  </div>
                    <div class="row">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $(document).on('click', 'button.open-Editexpense_categoryDialog', function() {
            var url = "transaction_adjustments/";
    ...
    $('#expense-table').DataTable( {
        ...
        "serverSide": true,
        "ajax":{
            url:"transaction_adjustments/transaction_adjustments-data",
            data:{
