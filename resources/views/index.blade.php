        ...
        <div class="container-fluid">
          <div class="col-md-12">
            ...
            <div class="filter-toggle btn-group">
              ...
              <button class="btn btn-secondary date-btn" data-start_date="{{date('Y-m-d', strtotime(' -30 day'))}}" data-end_date="{{date('Y-m-d')}}">Last 30 Days</button>
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title">
                    ...
                    <div>
                        ...
                        <div class="name"><strong style="color: #733686">Total Collected</strong></div>
                    </div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title">
                    ...
                    <div>
                        ...
                        <div class="name"><strong style="color: #ff8952">Ticket price</strong></div>
                    </div>
                  </div>
                </div>
                <!-- Count item widget-->
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title">
                    ...
                    <div>
                        ...
                        <div class="name"><strong style="color: #297ff9">Commission Fee</strong></div>
                    </div>
                  </div>
                </div>
              </div>
