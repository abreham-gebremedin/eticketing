    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">Purchase Transfer List</h3>
            </div>
            {!! Form::open(['route' => 'transfer-purchase.index', 'method' => 'get']) !!}
            <div class="row mb-3">
        ...
        @if(in_array("purchasetransfer-add", $all_permission))
            <a href="#" data-toggle="modal" data-target="#add-purchase-transfer" class="btn btn-info"><i class="dripicons-plus"></i>  Add purchase Transfer</a>
        @endif
    </div>
        ...
        <table id="return-table" class="table return-list" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th>From {{trans('file.Warehouse')}}</th>
                    <th>To Warehouse</th>
...
<div id="add-purchase-transfer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        {!! Form::open(['route' => 'transfer-purchase.create', 'method' => 'get']) !!}
      ...
      <div class="modal-content">
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                <i style="font-size: 15px;">Purchase Transfer Details
</i>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $("ul#PurchaseTransfer").siblings('a').attr('aria-expanded','true');
    $("ul#PurchaseTransfer").addClass("show");
    $("ul#return #purchase-transfer-menu").addClass("active");
    ...
    $('#return-table').DataTable( {
        ...
        "serverSide": true,
        "ajax":{
            url:"transfer-purchase/transfer-data",
            data:{
    ...
    function returnDetails(returns){
        //  console.log(returns);
        $('input[name="transfer_id"]').val(returns[11]);
        ...
        $.get('transfer-purchase/purchase_transfer/' + returns[11], function(data){
