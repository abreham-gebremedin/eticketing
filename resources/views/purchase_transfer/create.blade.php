            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'transfer-purchase.store', 'method' => 'post', 'files' => true, 'class' => 'payment-form']) !!}
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                        ...
                                                        if ($product_purchase->qty -  ($product_purchase->transferred_qty+$product_purchase->returned_qty)<=0) {
                                                            # code...
                                                            $actual_qty= 0;
                                                        } else {
                                                            # code...
                                                            $actual_qty= $product_purchase->qty-  ($product_purchase->transferred_qty+$product_purchase->returned_qty);
...
$("#myTable").on('input', '.qty', function() {
    ...
    if(parseInt($(this).attr('max')) <  parseInt($(this).val())) {
      $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ') .qty').val(1);
      alert("Quantity can't be greater than the Actual Quantity");
    }
    calculateTotal();
});
...
function calculateTotal() {
    ...
    $(".is-return").each(function(i) {
        if ($(this).is(":checked")) {
            ...
            if (isNaN(qty) || parseFloat(qty) <= 0 || parseFloat(qty) % 1 !== 0) {
                 alert('Quantity must be a positive integer!');
                  qty = actual_qty;
                  $('table.order-list tbody tr:nth-child(' + (i + 1) + ') .qty').val(actual_qty);
                  $(this).prop('checked', false);
                  submitButton.prop('disabled', true);
                } else if (parseFloat(qty) > parseFloat(actual_qty)) {
