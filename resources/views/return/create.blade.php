                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                        ...
                                                        if ($product_sale->qty - $product_sale->returned_qty<=0) {
                                                            # code...
                                                            $actual_qty= 0;
                                                        } else {
                                                            # code...
                                                            $actual_qty= $product_sale->qty- $product_sale->returned_qty;
                                                    ...
                                                    ?>
                                                        ...
                                                        <input type="hidden" class="product_sale" name="product_sale_id[]" value="{{$product_sale->id}}">
