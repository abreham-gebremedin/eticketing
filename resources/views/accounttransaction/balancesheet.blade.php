...
<div class="container-fluid">
        <div class="card">
            ...
            {!! Form::open(['route' => 'accounttransaction.Balance_Sheet', 'method' => 'get']) !!}
    ...
    <div class="table-responsive">
        <table id="ledger-report-table" class="table table-hover" style="width: 100%">
            <thead> 
                <tr>
                     <th>Accounts </th>
                    <th> </th>
    ...
    <div class="container-fluid">
        <div class="card">
      {!! Form::open(['route' => 'accounttransaction.Close_Account', 'method' => 'post']) !!}
            <div class="row mb-3 ">
                <div class="col-md-4 offset-md-2 mt-3">
                ...
                <div class="col-md-2 mt-3">
                    <div class="form-group">
                                <input type="hidden" name="start_date" value="{{$start_date}}" />
                                <input type="hidden" name="end_date" value="{{$end_date}}" />
                        <button class="btn btn-primary" type="submit">Close Accounts</button>
                    </div>
                </div>
                <div class="col-md-4 mt-3">
...
$("ul#account").siblings('a').attr('aria-expanded','true');
    ...
    $("ul#account #financial-menu").addClass("active");
