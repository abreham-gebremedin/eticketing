        ...
        <table id="employee-table" class="table shareholder" >
            ...
            <tbody>
                ...
                <tr data-id="{{$shareholder->id}}">
                    <td>{{$key}}</td>
                    @if($shareholder->shareholder->image)
                    <td> <img src="{{url('public/images/shareholder',$shareholder->shareholder->image)}}" height="80" width="80">
                    </td>
                    @else
                    <td>No Image</td>
                    @endif
                    ...
                    <td>{{ $shareholder->reason }}</td>
                     <td>{{$shareholder->pt}}{{ $shareholder->amount }}</td>
                       <td>
                        <div class="btn-group">
                            ...
                            @if($shareholder->pt=="+")
                            <li><a href="gen_invoice/{{$shareholder->id}}" class="btn btn-link"><i class="fa fa-copy"></i> Generate Invoice</a></li>
                            @endif 

                            @if($shareholder->pt=="-")
                            <li><a href="gen_detail/{{$shareholder->id}}" class="btn btn-link"><i class="fa fa-copy"></i> Detail</a></li>
                            @endif 
                            ...
                            @if(in_array("shareholders-add", $all_permission))
                             <li>
                            <button type="button" class="add-payment btn btn-link" data-id = "{{$shareholder->id}}" data-toggle="modal" data-target="#add-payment"><i class="fa fa-plus"></i> {{trans('file.Add Payment')}}</button>
                            </li>
                            @endif  
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                        ...
                        <div class="col-md-6 mt-1">
                            <label>{{trans('file.Paid By')}}</label>
                            <select name="add_payment_paid_by_id" class="form-control">
                                <option value="1">Cash</option>
                                <!-- <option value="2">Gift Card</option> -->
                                <!-- <option value="3">Credit Card</option> -->
                                <option value="4">Cheque</option>
...
<script type="text/javascript">
    ...
    $(document).on("click", "table.shareholder tbody .withdraw-share", function(event) {
        ...
        $('input[name="shareholder_id"]').val(shareholder_id);
