        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <?php echo '<img style="margin-top:10px;" src="data:image/svg+xml;base64,' . base64_encode(DNS1D::getBarcodeSVG($lims_sale_data->reference_no, 'C128')) . '" width="300" alt="barcode"   />';?>
                    <br>
                    <?php echo '<img style="margin-top:10px;" src="data:image/svg+xml;base64,' .base64_encode( DNS2D::getBarcodeSVG($lims_sale_data->reference_no, 'QRCODE') ). '" alt="barcode"   />';?>    
                    </td>
                </tr>
            </tbody>
        </table>
