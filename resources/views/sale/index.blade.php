            ...
            <div class="modal-body">
                {!! Form::open(['route' => 'sale.add-payment', 'method' => 'post', 'files' => true, 'class' => 'payment-form' ]) !!}
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>{{trans('file.Recived Amount')}} *</label>
        ...
        $.get('sales/getpayment/' + id, function(data) {
            ...
            $.each(payment_date, function(index){
                ...
                cols += '<td>' + cheque_bank[index] + '</td>';
                 ...
                 cols += '<td>' + mbtn_no[index] + '</td>';
                 cols += '<td>' + mobile_bank[index] + '</td>';
    ...
    $("table.payment-list").on("click", ".edit-btn", function(event) {
        ...
        $.each(payment_id, function(index){
            if(payment_id[index] == parseFloat(id)){
                ...
                }else if(paying_method[index] == 'Mobile'){
                    $('select[name="edit_paid_by_id"]').val(11);
                    $("#edit-cheque").show();
                    $('input[name="edit_cheque_no"]').val(cheque_no[index]);
                ...
                }else if(paying_method[index] == 'POS ATM'){
                    $('select[name="edit_paid_by_id"]').val(12);
                    $("#edit-mobile").hide();
...
$('select[name="paid_by_id"]').on("change", function() {
    ...
    $('input[name="amount"]').on("input", function() {
        if( $(this).val() > parseFloat($('input[name="paying_amount"]').val()) ) {
            alert('Recived amount cannot be bigger than Paying amount');
            $(this).val('0');
        }
    ...
    $('input[name="edit_amount"]').on("input", function() {
        ...
        else if( parseFloat($('input[name="edit_paying_amount"]').val())<=0) {
        alert('recieved  amount cannot be less than 0.');
        $(this).val('0');
       }
