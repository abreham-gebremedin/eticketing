            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="payment-options">
                        ...
                        <div class="column-5">
                            <button style="background: #213170" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="cash-btn"><i class="fa fa-money"></i> {{trans('file.Cash')}}</button>
                        </div>
                        <div class="column-5">
                            <button style="background: #00cec9" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="pos-btn"><i class="fa fa-credit-card"></i>POS ATM</button>
                        </div>
                        ...
                        <div class="column-5">
                            <button style="background-color: #5f27cd" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="mobile-btn"><i class="fa fa-mobile"></i> Mobile Banking</button>
                        </div>
                        <div class="column-5">
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-1">
                                            ...
                                            <input type="number" name="paid_amount" class="form-control numkey" required  step="any" min="0">
                                        </div>
                                        <div class="col-md-6 mt-1">
                                      ...
                                      <div  class="col-md-6 mt-1">
                                            ...
                                            <select class="form-control selectpicker" name="bank_acc">
                                      ...
                                      <div class="form-group col-md-12 mobile">
                            ...
                            <div class="col-md-12">
                                <table class="table table-hover">
                                    <tbody>
                                        ...
                                        <tr>
                                          <td>Mobile Banking Payment:</td>
                                          <td class="mobile_payment text-right"></td>
                                        </tr>
                                        <tr>
                                          <td>POS ATM Payment:</td>
                                          <td class="pos_payment text-right"></td>
                                        </tr>
                                        <tr>
  ...
  $("#register-details-btn").on("click", function (e) {
      ...
      $.ajax({
          ...
          success:function(data) {
              ...
              $('#register-details-modal .mobile_payment').text(data['mobile_payment']);
              $('#register-details-modal .pos_payment').text(data['pos_payment']);
  ...
  $("#today-sale-btn").on("click", function (e) {
      ...
      $.ajax({
          ...
          success:function(data) {
              ...
              $('#today-sale-modal .pos_payment').text(data['pos_payment']);
...
$("#draft-btn").on("click",function(){
    ...
    $('input[name="paid_amount"]').prop('required',true);
...
$("#cheque-btn").on("click",function() {
    ...
    var id = 4;
    if(id==1) {
        select_cash_account(6);
    }else{
        $('select[name="bank_acc"]').empty();
        populate_Account(6);
    }
    cheque();
});
...
if( $('select[name="paid_by_id_select"]').val() == 1 ){
    select_cash_account(6);
    }

function select_cash_account(unitID){
        $.ajax({
            url: 'accounts/taccount/'+unitID,
            type: "GET",
            dataType: "json",
            success:function(data) {
                  $('select[name="bank_acc"]').empty();
                   $.each(data, function(key, value) {
                      $('select[name="bank_acc"]').append('<option value="'+ key +'">'+ value +'</option>');
                   });
                  $('.selectpicker').selectpicker('refresh');
            },
        });
    ...
    function populate_Account(unitID){
        $.ajax({
            url: 'accounts/taccount2/'+unitID,
            type: "GET",
            dataType: "json",
            success:function(data) {
                  $('select[name="bank_acc"]').empty();
                //    $.each(data, function() {
                    for (let index = 0; index < data.length; index++) {
                        $('select[name="bank_acc"]').append('<option value="'+ data[index]['id'] +'">'+ data[index]['name']+'(' + data[index]['account_no'] +')'+'</option>');
...
$('#add-payment input[name="paid_amount"]').on("input", function() {
...
$('input[name="paid_amount"]').on("input", function() {
    ...
    if( $(this).val() > parseFloat($('input[name="paying_amount"]').val()) ) {
        alert('recieved  amount cannot be bigger than Paying amount');
        $(this).val('0');
    }
    else if( $(this).val() > parseFloat($('#grand-total').text()) ){
        alert('recieved amount cannot be bigger than grand total');
        $(this).val('0');
    }else if( $(this).val()<0 || $(this).val()=='') {
        alert('recieved  amount cannot be less than 0.');
        $(this).val('0');
    }
...
$(document).on('click', '.qc-btn', function(e) {
    if($(this).data('amount')) {
        if($('.qc').data('initial')) {
            $('input[name="paid_amount"]').val( $(this).data('amount').toFixed(2) );
            $('.qc').data('initial', 0);
        }
        else {
            $('input[name="paid_amount"]').val( (parseFloat($('input[name="paid_amount"]').val()) + $(this).data('amount')).toFixed(2) );
        }
    }
    else
...
$(document).on('submit', '.payment-form', function(e) {
    ...
    $('input[name="account_id"]').val($('select[name="bank_acc"]').val());
