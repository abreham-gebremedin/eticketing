                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" min="0" name="paying_amount" class="form-control numkey"  step="any">
                                        </div>
                                        <div class="col-md-6">
                                            <label>{{trans('file.Paying Amount')}} *</label>
                                            <input type="number" min="0"  name="paid_amount" class="form-control numkey"  step="any">
                                        </div>
