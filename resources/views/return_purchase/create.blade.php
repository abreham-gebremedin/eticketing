                            ...
                            <div class="col-md-12">                                
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="hidden" name="reference_no" value="{{$lims_purchase_data->reference_no}}">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td><input type="checkbox" class="is-return" name="is_return[]" value="{{$product_data->code}}"></td>
