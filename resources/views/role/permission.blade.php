						    ...
						    <table class="table table-bordered permission-table">
								...
								<tr>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("buses-index", $all_permission))
								                <input type="checkbox" value="1" id="buses-index" name="buses-index" checked />
								                @else
								                <input type="checkbox" value="1" id="buses-index" name="buses-index" />
								                @endif
								                <label for="buses-index"></label>
							            	</div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("buses-add", $all_permission))
								               	<input type="checkbox" value="1" id="buses-add" name="buses-add" checked>
								                @else
								                <input type="checkbox" value="1" id="buses-add" name="buses-add">
								                @endif
								                <label for="buses-add"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                ...
								                <input type="checkbox" value="1" id="buses-edit" name="buses-edit" checked />
								                @else
								                <input type="checkbox" value="1" id="buses-edit" name="buses-edit" />
								                @endif
								                <label for="buses-edit"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("buses-delete", $all_permission))
								                <input type="checkbox" value="1" id="buses-delete" name="buses-delete" checked />
								                @else
								                <input type="checkbox" value="1" id="buses-delete" name="buses-delete" />
								                @endif
								                <label for="buses-delete"></label>
							                </div>
							            </div>
						            </td>
						        </tr>
						                ...
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("ticket-add", $all_permission))
								               	<input type="checkbox" value="1" id="ticket-add" name="ticket-add" checked>
								                @else
								                <input type="checkbox" value="1" id="ticket-add" name="ticket-add">
								                @endif
								                <label for="ticket-add"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
								...
								<tr>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("ticketofficers-index", $all_permission))
								                <input type="checkbox" value="1" id="ticketofficers-index" name="ticketofficers-index" checked />
								                @else
								                <input type="checkbox" value="1" id="ticketofficers-index" name="ticketofficers-index" />
								                @endif
								                <label for="ticketofficers-index"></label>
							            	</div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("ticketofficers-add", $all_permission))
								               	<input type="checkbox" value="1" id="ticketofficers-add" name="ticketofficers-add" checked>
								                @else
								                <input type="checkbox" value="1" id="ticketofficers-add" name="ticketofficers-add">
								                @endif
								                <label for="ticketofficers-add"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("ticketofficers-edit", $all_permission))
								                <input type="checkbox" value="1" id="ticketofficers-edit" name="ticketofficers-edit" checked />
								                @else
								                <input type="checkbox" value="1" id="ticketofficers-edit" name="ticketofficers-edit" />
								                @endif
								                <label for="ticketofficers-edit"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("ticketofficers-delete", $all_permission))
								                <input type="checkbox" value="1" id="ticketofficers-delete" name="ticketofficers-delete" checked />
								                @else
								                <input type="checkbox" value="1" id="ticketofficers-delete" name="ticketofficers-delete" />
								                @endif
								                <label for="ticketofficers-delete"></label>
							                </div>
							            </div>
						            </td>
						        </tr>
								...
								<tr>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("route-index", $all_permission))
								                <input type="checkbox" value="1" id="route-index" name="route-index" checked />
								                @else
								                <input type="checkbox" value="1" id="route-index" name="route-index" />
								                @endif
								                <label for="route-index"></label>
							            	</div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("route-add", $all_permission))
								               	<input type="checkbox" value="1" id="route-add" name="route-add" checked>
								                @else
								                <input type="checkbox" value="1" id="route-add" name="route-add">
								                @endif
								                <label for="route-add"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("route-edit", $all_permission))
								                <input type="checkbox" value="1" id="route-edit" name="route-edit" checked />
								                @else
								                <input type="checkbox" value="1" id="route-edit" name="route-edit" />
								                @endif
								                <label for="route-edit"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                ...
								                <input type="checkbox" value="1" id="route-delete" name="route-delete" checked />
								                @else
								                <input type="checkbox" value="1" id="route-delete" name="route-delete" />
								                @endif
								                <label for="ticketofficers-delete"></label>
							                </div>
							            </div>
								...
								<tr>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("que-index", $all_permission))
								                <input type="checkbox" value="1" id="que-index" name="que-index" checked />
								                @else
								                <input type="checkbox" value="1" id="que-index" name="que-index" />
								                @endif
								                <label for="que-index"></label>
							            	</div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("que-add", $all_permission))
								               	<input type="checkbox" value="1" id="que-add" name="que-add" checked>
								                @else
								                <input type="checkbox" value="1" id="que-add" name="que-add">
								                @endif
								                <label for="que-add"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("que-edit", $all_permission))
								                <input type="checkbox" value="1" id="que-edit" name="que-edit" checked />
								                @else
								                <input type="checkbox" value="1" id="que-edit" name="que-edit" />
								                @endif
								                <label for="que-edit"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("que-delete", $all_permission))
								                <input type="checkbox" value="1" id="que-delete" name="que-delete" checked />
								                @else
								                <input type="checkbox" value="1" id="que-delete" name="que-delete" />
								                @endif
								                <label for="que-delete"></label>
							                </div>
							            </div>
						            </td>
						        </tr>
						        ...
						        <tr>
						            <td>Purchase Transfer</td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("purchasetransfer-index", $all_permission))
								                <input type="checkbox" value="1" id="purchasetransfer-index" name="purchasetransfer-index" checked>
								                @else
								                <input type="checkbox" value="1" id="purchasetransfer-index" name="purchasetransfer-index">
								                @endif
								                <label for="purchasetransfer-index"></label>
							                </div>
							            </div>
						            </td>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("purchasetransfer-add", $all_permission))
								                <input type="checkbox" value="1" id="purchasetransfer-add" name="purchasetransfer-add" checked>
								                @else
								                <input type="checkbox" value="1" id="purchasetransfer-add" name="purchasetransfer-add">
								                @endif
								                <label for="purchasetransfer-add"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("purchasetransfer-edit", $all_permission))
								                <input type="checkbox" value="1" id="purchasetransfer-edit" name="purchasetransfer-edit" checked />
								                @else
								                <input type="checkbox" value="1" id="purchasetransfer-edit" name="purchasetransfer-edit">
								                @endif
								                <label for="purchasetransfer-edit"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("purchasetransfer-delete", $all_permission))
								                <input type="checkbox" value="1" id="purchasetransfer-delete" name="purchasetransfer-delete" checked>
								                @else
								                <input type="checkbox" value="1" id="purchasetransfer-delete" name="purchasetransfer-delete">
								                @endif
								                <label for="purchasetransfer-delete"></label>
							            	</div>
						            	</div>
						            </td>
								</tr>
								<tr>
						            <td>Warehouse Purchase</td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("warehousepurchases-index", $all_permission))
								                <input type="checkbox" value="1" id="warehousepurchases-index" name="warehousepurchases-index" checked>
								                @else
								                <input type="checkbox" value="1" id="warehousepurchases-index" name="warehousepurchases-index">
								                @endif
								                <label for="warehousepurchases-index"></label>
							                </div>
							            </div>
						            </td>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("warehousepurchases-add", $all_permission))
								                <input type="checkbox" value="1" id="warehousepurchases-add" name="warehousepurchases-add" checked>
								                @else
								                <input type="checkbox" value="1" id="warehousepurchases-add" name="warehousepurchases-add">
								                @endif
								                <label for="warehousepurchases-add"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("warehousepurchases-edit", $all_permission))
								                <input type="checkbox" value="1" id="warehousepurchases-edit" name="warehousepurchases-edit" checked />
								                @else
								                <input type="checkbox" value="1" id="warehousepurchases-edit" name="warehousepurchases-edit">
								                @endif
								                <label for="warehousepurchases-edit"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("warehousepurchases-delete", $all_permission))
								                <input type="checkbox" value="1" id="warehousepurchases-delete" name="warehousepurchases-delete" checked>
								                @else
								                <input type="checkbox" value="1" id="warehousepurchases-delete" name="warehousepurchases-delete">
								                @endif
								                <label for="warehousepurchases-delete"></label>
							            	</div>
						            	</div>
						            </td>
								</tr>
								...
								<tr>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("transaction_adjustments-index", $all_permission))
								                <input type="checkbox" value="1" id="transaction_adjustments-index" name="transaction_adjustments-index" checked>
								                @else
								                <input type="checkbox" value="1" id="transaction_adjustments-index" name="transaction_adjustments-index">
								                @endif
								                <label for="transaction_adjustments-index"></label>
							                </div>
							            </div>
						            </td>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                ...
								                <input type="checkbox" value="1" id="transaction_adjustments-add" name="transaction_adjustments-add" checked>
								                @else
								                <input type="checkbox" value="1" id="transaction_adjustments-add" name="transaction_adjustments-add">
								                @endif
								                <label for="transaction_adjustments-add"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("transaction_adjustments-edit", $all_permission))
								                <input type="checkbox" value="1" id="transaction_adjustments-edit" name="transaction_adjustments-edit" checked />
								                @else
								                <input type="checkbox" value="1" id="transaction_adjustments-edit" name="transaction_adjustments-edit">
								                @endif
								                <label for="transaction_adjustments-edit"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("transaction_adjustments-delete", $all_permission))
								                <input type="checkbox" value="1" id="transaction_adjustments-delete" name="transaction_adjustments-delete" checked>
								                @else
								                <input type="checkbox" value="1" id="transaction_adjustments-delete" name="transaction_adjustments-delete">
								                @endif
								                <label for="transaction_adjustments-delete"></label>
							            	</div>
						            	</div>
						            </td>
								</tr>
								...
								<tr>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("shareholders-index", $all_permission))
								                <input type="checkbox" value="1" id="shareholders-index" name="shareholders-index" checked>
								                @else
								                <input type="checkbox" value="1" id="shareholders-index" name="shareholders-index">
								                @endif
								                <label for="shareholders-index"></label>
							                </div>
							            </div>
						            </td>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                ...
								                <input type="checkbox" value="1" id="shareholders-add" name="shareholders-add" checked>
								                @else
								                <input type="checkbox" value="1" id="shareholders-add" name="shareholders-add">
								                @endif
								                <label for="shareholders-add"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                ...
								                <input type="checkbox" value="1" id="shareholders-edit" name="shareholders-edit" checked />
								                @else
								                <input type="checkbox" value="1" id="shareholders-edit" name="shareholders-edit">
								                @endif
								                <label for="shareholders-edit"></label>
							                </div>
							            </div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                ...
								                <input type="checkbox" value="1" id="shareholders-delete" name="shareholders-delete" checked>
								                @else
								                <input type="checkbox" value="1" id="shareholders-delete" name="shareholders-delete">
								                @endif
								                <label for="shareholders-delete"></label>
							            	</div>
						            	</div>
						            </td>
								</tr>
								...
								<tr>
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("fixed_asset-index", $all_permission))
								                <input type="checkbox" value="1" id="fixed_asset-index" name="fixed_asset-index" checked />
								                @else
								                <input type="checkbox" value="1" id="fixed_asset-index" name="fixed_asset-index">
								                @endif
								                <label for="fixed_asset-index"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                ...
								                <input type="checkbox" value="1" id="fixed_asset-add" name="fixed_asset-add" checked />
								                @else
								                <input type="checkbox" value="1" id="fixed_asset-add" name="fixed_asset-add">
								                @endif
								                <label for="fixed_asset-add"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("fixed_asset-edit", $all_permission))
								                <input type="checkbox" value="1" id="fixed_asset-edit" name="fixed_asset-edit" checked>
								                @else
								                <input type="checkbox" value="1" id="fixed_asset-edit" name="fixed_asset-edit">
								                @endif
								                <label for="fixed_asset-edit"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                @if(in_array("fixed_asset-delete", $all_permission))
								                <input type="checkbox" value="1" id="fixed_asset-delete" name="fixed_asset-delete" checked>
								                @else
								                <input type="checkbox" value="1" id="fixed_asset-delete" name="fixed_asset-delete">
								                @endif
								                <label for="fixed_asset-delete"></label>
								            </div>
						            	</div>
						            </td>
						        </tr>
