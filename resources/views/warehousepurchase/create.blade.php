            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'warehousepurchases.store', 'method' => 'post', 'files' => true, 'id' => 'purchase-form']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4">
...
<script type="text/javascript">
    ...
    $("ul#purchasewarehouse #purchasewarehouse-create-menu").addClass("active");
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(flag){
                    ...
                    cols += '<td>' + data[1] + '</td>';
                    cols += '<td> <select name="is_new[]" class="form-control is_new"> <option value="1">New</option><option value="0">Second Hand(used)</option> </select> </td>';
