...
return [
	...
	"product" => "ምርት",
	"category" => "ምድብ",
	"product_list" => "የምርት_ዝርዝር",
	"add_product" => "አዲስ ምርት ይጨምሩ",
	"import_product" => "ምርት Import",
	...
	"submit" => "አስቀምጥ",
	"update" => "አዘምን",
	"The field labels marked with * are required input fields" => "በ* ምልክት የተደረገባቸው የመስክ መለያዎች መሙላት ይጠበቅባቸዋል",
	"settings" => "መቼቶች",
	"logout" => "ውጣ",
	"return" => "መመለስ",
	"profit" => "ትርፍ",
	...
	"latest" => "የቅርብ ጊዜ",
	"best selling product" => "ምርጥ የሚሸጥ ምርት",
	"top" => "ከፍተኛ",
	"date" => "ቀን",
	"reference" => "ማጣቀሻ",
	"customer" => "ደንበኛ",
	...
	"Price" => "ዋጋ",
	"Type" => "ዓይነት",
	"Barcode Symbology" => "ባርኮድ ሲምቦሎጂ",
	"Sale" => "ሽያጭ",
	"Purchase" => "ግዢ",
	"Cost" => "ወጪ",
	"Alert" => "ማንቂያ",
	"Promotional Price" => "የማስተዋወቂያ ዋጋ",
	"Promotion" => "ማስተዋወቂያ",
	"Featured" => "ተለይቶ የቀረበ",
	"Tax" => "ግብር or tax",
	"Invoice Details" => "የክፍያ መጠየቂያ ዝርዝሮች",
	"Generate" => "Generate",
	"Promotion Starts" => "ማስተዋወቅ ይጀምራል",
	"Promotion Ends" => "ማስተዋወቅ ያበቃል",
	"Date" => "ቀን",
	"Starting" => "በመጀመር ላይ",
	"Ending" => "መጨረሻ ላይ",
	"Print" => "አትም",
	...
	"Unit Cost" => "ነጠላ ወጪ",
	"Unit Price" => "ነጠላ ዋጋ",
	"Net Unit Cost" => "የተጣራ ነጠላ ወጪ",
	"Net Unit Price" => "የተጣራ ነጠላ ዋጋ",
	...
	'Download Sample File' => 'ናሙና ፋይል አውርድ',
	...
	"Method" => "Method",
	"Sale Return" => "የተመለሰ ሽያጭ",
	"Purchase Return" => "የተመለሰ ግዢ",
	"Net Sale Return" => "የተጣራ የተመለሰ ሽያጭ",
	"Net Purchase Return" => "የተጣራ የተመለሰ ግዢ",
	...
	"Points" =>"Points",
	"Cancel" =>"አቋርጥ",
	"Recent Transaction" =>"የቅርብ ጊዜ ግብይት",
