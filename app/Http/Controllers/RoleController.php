...
class RoleController extends Controller
{
    ...
    public function setPermission(Request $request)
    {
        ...
        if($request->has('buses-index')){
                $permission = Permission::firstOrCreate(['name' => 'buses-index']);
                if(!$role->hasPermissionTo('buses-index')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('buses-index');
    
            if($request->has('buses-add')){
                $permission = Permission::firstOrCreate(['name' => 'buses-add']);
                if(!$role->hasPermissionTo('buses-add')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('buses-add');
            if($request->has('buses-edit')){
                $permission = Permission::firstOrCreate(['name' => 'buses-edit']);
                if(!$role->hasPermissionTo('buses-edit')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('buses-edit');
    
            if($request->has('buses-delete')){
                $permission = Permission::firstOrCreate(['name' => 'buses-delete']);
                if(!$role->hasPermissionTo('buses-delete')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('buses-delete');
                ...
                if($request->has('que-index')){
                $permission = Permission::firstOrCreate(['name' => 'que-index']);
                if(!$role->hasPermissionTo('que-index')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('que-index');
    
            if($request->has('que-add')){
                $permission = Permission::firstOrCreate(['name' => 'que-add']);
                if(!$role->hasPermissionTo('que-add')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('que-add');
            if($request->has('que-edit')){
                $permission = Permission::firstOrCreate(['name' => 'que-edit']);
                if(!$role->hasPermissionTo('que-edit')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('que-edit');
    
            if($request->has('que-delete')){
                $permission = Permission::firstOrCreate(['name' => 'que-delete']);
                if(!$role->hasPermissionTo('que-delete')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('que-delete');
                ...
                if($request->has('route-index')){
                $permission = Permission::firstOrCreate(['name' => 'route-index']);
                if(!$role->hasPermissionTo('route-index')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('route-index');
    
            if($request->has('route-add')){
                $permission = Permission::firstOrCreate(['name' => 'route-add']);
                if(!$role->hasPermissionTo('route-add')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('route-add');
            if($request->has('route-edit')){
                $permission = Permission::firstOrCreate(['name' => 'route-edit']);
                if(!$role->hasPermissionTo('route-edit')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('route-edit');
    
            if($request->has('route-delete')){
                $permission = Permission::firstOrCreate(['name' => 'route-delete']);
                if(!$role->hasPermissionTo('route-delete')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('route-delete');
                ...
                if($request->has('ticketofficers-index')){
                $permission = Permission::firstOrCreate(['name' => 'ticketofficers-index']);
                if(!$role->hasPermissionTo('ticketofficers-index')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('ticketofficers-index');
    
            if($request->has('ticketofficers-add')){
                $permission = Permission::firstOrCreate(['name' => 'ticketofficers-add']);
                if(!$role->hasPermissionTo('ticketofficers-add')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('ticketofficers-add');
            if($request->has('ticketofficers-edit')){
                $permission = Permission::firstOrCreate(['name' => 'ticketofficers-edit']);
                if(!$role->hasPermissionTo('ticketofficers-edit')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('ticketofficers-edit');
    
            if($request->has('ticketofficers-delete')){
                $permission = Permission::firstOrCreate(['name' => 'ticketofficers-delete']);
                if(!$role->hasPermissionTo('ticketofficers-delete')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('ticketofficers-delete');
            ...
            if($request->has('ticket-add')){
                $permission = Permission::firstOrCreate(['name' => 'ticket-add']);
                if(!$role->hasPermissionTo('ticket-add')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('ticket-add');
        ...
        if($request->has('warehousepurchases-index')){
            $permission = Permission::firstOrCreate(['name' => 'warehousepurchases-index']);
            if(!$role->hasPermissionTo('warehousepurchases-index')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('warehousepurchases-index');

        if($request->has('warehousepurchases-add')){
            $permission = Permission::firstOrCreate(['name' => 'warehousepurchases-add']);
            if(!$role->hasPermissionTo('warehousepurchases-add')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('warehousepurchases-add');

        if($request->has('warehousepurchases-edit')){
            $permission = Permission::firstOrCreate(['name' => 'warehousepurchases-edit']);
            if(!$role->hasPermissionTo('warehousepurchases-edit')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('warehousepurchases-edit');

        if($request->has('warehousepurchases-delete')){
            $permission = Permission::firstOrCreate(['name' => 'warehousepurchases-delete']);
            if(!$role->hasPermissionTo('warehousepurchases-delete')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('warehousepurchases-delete');
        



        if($request->has('shareholders-index')){
            $permission = Permission::firstOrCreate(['name' => 'shareholders-index']);
            if(!$role->hasPermissionTo('shareholders-index')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('shareholders-index');

        if($request->has('shareholders-add')){
            $permission = Permission::firstOrCreate(['name' => 'shareholders-add']);
            if(!$role->hasPermissionTo('shareholders-add')){
                $role->givePermissionTo($permission);
            }
        }
        else{
            $role->revokePermissionTo('shareholders-add');

        }

        if($request->has('shareholders-edit')){
            $permission = Permission::firstOrCreate(['name' => 'shareholders-edit']);
            if(!$role->hasPermissionTo('shareholders-edit')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('shareholders-edit');



        if($request->has('shareholders-delete')){
            $permission = Permission::firstOrCreate(['name' => 'shareholders-delete']);
            if(!$role->hasPermissionTo('shareholders-delete')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('shareholders-delete');



            if($request->has('transaction_adjustments-index')){
                $permission = Permission::firstOrCreate(['name' => 'transaction_adjustments-index']);
                if(!$role->hasPermissionTo('transaction_adjustments-index')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('transaction_adjustments-index');
    
            if($request->has('transaction_adjustments-add')){
                $permission = Permission::firstOrCreate(['name' => 'transaction_adjustments-add']);
                if(!$role->hasPermissionTo('transaction_adjustments-add')){
                    $role->givePermissionTo($permission);
                }
            }
            else{
                $role->revokePermissionTo('transaction_adjustments-add');
    
            }
    
            if($request->has('transaction_adjustments-edit')){
                $permission = Permission::firstOrCreate(['name' => 'transaction_adjustments-edit']);
                if(!$role->hasPermissionTo('transaction_adjustments-edit')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('transaction_adjustments-edit');
    
    
    
            if($request->has('transaction_adjustments-delete')){
                $permission = Permission::firstOrCreate(['name' => 'transaction_adjustments-delete']);
                if(!$role->hasPermissionTo('transaction_adjustments-delete')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('transaction_adjustments-delete');
    
    

        if($request->has('purchasetransfer-index')){
            $permission = Permission::firstOrCreate(['name' => 'purchasetransfer-index']);
            if(!$role->hasPermissionTo('purchasetransfer-index')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('purchasetransfer-index');

            
        if($request->has('purchasetransfer-edit')){
            $permission = Permission::firstOrCreate(['name' => 'purchasetransfer-edit']);
            if(!$role->hasPermissionTo('purchasetransfer-edit')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('purchasetransfer-edit');

        if($request->has('purchasetransfer-delete')){
            $permission = Permission::firstOrCreate(['name' => 'purchasetransfer-delete']);
            if(!$role->hasPermissionTo('purchasetransfer-delete')){
                $role->givePermissionTo($permission);
            }
        }
        else
            $role->revokePermissionTo('purchasetransfer-delete');
        ...
        if($request->has('expenses-delete')){
            ...
            if($request->has('fixed_asset-index')){
                $permission = Permission::firstOrCreate(['name' => 'fixed_asset-index']);
                if(!$role->hasPermissionTo('fixed_asset-index')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('fixed_asset-index');
    
            if($request->has('fixed_asset-add')){
                $permission = Permission::firstOrCreate(['name' => 'fixed_asset-add']);
                if(!$role->hasPermissionTo('fixed_asset-add')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('fixed_asset-add');
    
            if($request->has('fixed_asset-edit')){
                $permission = Permission::firstOrCreate(['name' => 'fixed_asset-edit']);
                if(!$role->hasPermissionTo('fixed_asset-edit')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('fixed_asset-edit');
    
            if($request->has('fixed_asset-delete')){
                $permission = Permission::firstOrCreate(['name' => 'fixed_asset-delete']);
                if(!$role->hasPermissionTo('fixed_asset-delete')){
                    $role->givePermissionTo($permission);
                }
            }
            else
                $role->revokePermissionTo('fixed_asset-delete');
